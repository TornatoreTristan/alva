...
const Isolation = ({ nextStep }: any) => {
    ...
    console.log(sessionStorage.getItem("logementData"));
    ...
    useEffect(() => {
        ...
        const savedData = sessionStorage.getItem("isolationData");
        if (savedData) {
            const { murIsolation, toiture, combles, sousSol, facades, fenetres, vitrage } = JSON.parse(savedData);
            setMurIsolation(murIsolation);
            setToiture(toiture);
            setCombles(combles);
            setSousSol(sousSol);
            setFacades(facades);
    ...
    useEffect(() => {
        ...
        sessionStorage.setItem("isolationData", JSON.stringify(isolationData));
    }, [murIsolation, toiture, combles, sousSol, facades, fenetres, vitrage]);
        ...
        <div className="p-8 bg-[#F9FFE6] rounded-lg border border-primary my-12">
            ...
            <div className="mb-8">
                ...
                <div className="flex justify-center gap-8">
                    {["- de 10 ans", "+ de 10 ans", "Aucun travaux"].map((option) => (
                        <div key={option} className={`flex items-center justify-between p-6 border rounded-lg cursor-pointer transition-all duration-300 ${murIsolation === option ? "border-primary bg-secondary" : "border-gray-200 bg-white"}`} onClick={() => handleMurIsolationSelect(option)}>
                            ...
                            <div className="ml-4">
                                <div className={`w-6 h-6 border-2 rounded-full flex items-center justify-center ${murIsolation === option ? "border-primary" : "border-gray-400"}`}>{murIsolation === option && <div className="w-3 h-3 bg-primary rounded-full"></div>}</div>
                            </div>
                        </div>
                    ))}
                </div>
                ...
                <div className="mb-8">
                    ...
                    <div className="flex justify-center gap-8">
                        {["Combles perdus", "Combles aménagés", "Toit terrasse"].map((option) => (
                            <div key={option} className={`flex items-center justify-between p-6 border rounded-lg cursor-pointer transition-all duration-300 ${toiture === option ? "border-primary bg-secondary" : "border-gray-200 bg-white"}`} onClick={() => handleToitureSelect(option)}>
                                ...
                                <div className="ml-4">
                                    <div className={`w-6 h-6 border-2 rounded-full flex items-center justify-center ${toiture === option ? "border-primary" : "border-gray-400"}`}>{toiture === option && <div className="w-3 h-3 bg-primary rounded-full"></div>}</div>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            {showCombles && (
                <div className="mb-8">
                    ...
                    <div className="flex justify-center gap-8">
                        {["- de 10 ans", "+ de 10 ans", "Aucun travaux"].map((option) => (
                            <div key={option} className={`flex items-center justify-between p-6 border rounded-lg cursor-pointer transition-all duration-300 ${combles === option ? "border-primary bg-secondary" : "border-gray-200 bg-white"}`} onClick={() => handleComblesSelect(option)}>
                                ...
                                <div className="ml-4">
                                    <div className={`w-6 h-6 border-2 rounded-full flex items-center justify-center ${combles === option ? "border-primary" : "border-gray-400"}`}>{combles === option && <div className="w-3 h-3 bg-primary rounded-full"></div>}</div>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <div className="mb-8">
                    ...
                    <div className="flex justify-center gap-8">
                        {["Terre-plein", "Vide sanitaire", "Sous-sol non chauffé"].map((option) => (
                            <div key={option} className={`flex items-center justify-between p-6 border rounded-lg cursor-pointer transition-all duration-300 ${sousSol === option ? "border-primary bg-secondary" : "border-gray-200 bg-white"}`} onClick={() => handleSousSolSelect(option)}>
                                ...
                                <div className="ml-4">
                                    <div className={`w-6 h-6 border-2 rounded-full flex items-center justify-center ${sousSol === option ? "border-primary" : "border-gray-400"}`}>{sousSol === option && <div className="w-3 h-3 bg-primary rounded-full"></div>}</div>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <div className="mb-8">
                    ...
                    <div className="flex justify-center gap-8">
                        {["Simple", "Double", "Triple"].map((option) => (
                            <div key={option} className={`flex items-center justify-between p-6 border rounded-lg cursor-pointer transition-all duration-300 ${vitrage === option ? "border-primary bg-secondary" : "border-gray-200 bg-white"}`} onClick={() => handleVitrageSelect(option)}>
                                ...
                                <div className="ml-4">
                                    <div className={`w-6 h-6 border-2 rounded-full flex items-center justify-center ${vitrage === option ? "border-primary" : "border-gray-400"}`}>{vitrage === option && <div className="w-3 h-3 bg-primary rounded-full"></div>}</div>
                                </div>
                            </div>
                        ))}
                    </div>
