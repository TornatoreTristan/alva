...
const Informations = ({ nextStep }: any) => {
    ...
    <div className="p-8 bg-[#F9FFE6] rounded-lg border border-primary my-12">
      ...
      <div className="mb-8">
        ...
        <div className="flex justify-center gap-8">
          ...
          >
            <option value="" disabled>Veuillez sélectionner un motif</option>
          ...
          <div className="flex justify-center gap-8">
            <div className="w-full">
              <input
                ...
                className="p-4 border rounded-lg w-full mb-4 text-lg"
              />
              <input
                type="tel"
                inputMode="numeric"
        ...
        <div className="mb-8">
          <div className="p-4">
            ...
            <p className="text-gray-500 text-sm mt-4">
              Vous pouvez retirer votre consentement à tout moment en cliquant sur le lien de désabonnement dans nos emails ou en contactant notre service client à l'adresse suivante : [email@example.com].
            </p>
            <p className="text-gray-500 text-sm mt-4">
              Pour plus d'informations sur la façon dont nous utilisons vos données, veuillez consulter notre <a href="#" className="text-blue-600 underline">Politique de Confidentialité</a>.
            </p>
          </div>
        </div>
      )}
