...
const SimulateurDPE = () => {
    ...
    const renderStep = () => {
        switch (currentStep) {
            ...
            case 6:
                return <Informations data={formData.informations} updateData={(data: any) => updateFormData("informations", data)} nextStep={() => setCurrentStep(7)} btn="Obtenir ma note DPE" />;
            case 7:
